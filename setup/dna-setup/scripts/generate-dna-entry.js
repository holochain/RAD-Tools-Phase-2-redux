...
// enter into hc nix-shell: ie run `nix-shell https://holochain.love`
// create new directory for happ: ie run `mkdir <HAPP_DNA_NAME>`
// create dna scaffold: ie run `hc init dna-src`
