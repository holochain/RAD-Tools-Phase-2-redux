...
use crate::user::UserEntry;
      ...
      pub fn validate_entry_user(entry: User, validation_data: hdk::ValidationData) -> Result<(), String> {
      ...
      pub fn validate_entry_user(old_entry: User, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
      ...
      pub fn validate_entry_user(new_entry: User, old_entry: NoteEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
